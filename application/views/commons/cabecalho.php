...
<html lang="pt_BR">
  <head>
    ...
    <meta name="description" content="Tutorial ensinando a fazer validação de formulário no CodeIgniter com a library Form Validation.">
    <meta name="author" content="Universidade CodeIgniter">
    <link rel="icon" href="<?=base_url('assets/images/unici/favicon.png')?>">

    <title>Validando formulários com a library Form Validation</title>
